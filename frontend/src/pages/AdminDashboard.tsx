...
export const AdminDashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 relative overflow-hidden">
      ...
      <div className="py-12 px-6 space-y-8 relative z-10">
      {/* Header */}
      <div className="relative">
        <div className="absolute top-0 left-0 right-0 h-full opacity-30 pointer-events-none">
          <Animated3DHeader title="Admin Dashboard" />
        </div>
        <h1 className="text-4xl font-black text-center mb-2 bg-gradient-to-r from-orange-500 via-red-500 to-pink-500 bg-clip-text text-transparent relative z-10">
          Admin Dashboard
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {stats.map((stat, index) => {
          ...
          return (
            ...
            >
              <Card className="p-6 hover:shadow-xl transition-all duration-300 border-l-4 border-orange-500 dark:border-orange-400">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Book Issues Trend */}
        <Card className="p-6">
          <h3 className="text-lg font-bold mb-4 bg-gradient-to-r from-orange-500 via-red-500 to-pink-500 bg-clip-text text-transparent">Book Issues Trend (Last 7 Days)</h3>
          <div className="h-64">
        ...
        <Card className="p-6">
          <h3 className="text-lg font-bold mb-4 bg-gradient-to-r from-orange-500 via-red-500 to-pink-500 bg-clip-text text-transparent">Member Registrations (Last 7 Days)</h3>
          <div className="h-64">
        ...
        {/* New Books Added */}
        <Card className="p-6">
          <h3 className="text-lg font-bold mb-4 bg-gradient-to-r from-orange-500 via-red-500 to-pink-500 bg-clip-text text-transparent">New Books Added (Last 7 Days)</h3>
          <div className="h-64">
        ...
        <Card className="p-6">
          <h3 className="text-lg font-bold mb-4 bg-gradient-to-r from-orange-500 via-red-500 to-pink-500 bg-clip-text text-transparent">Top 5 Popular Books</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="p-6">
          <h3 className="text-lg font-bold mb-4 flex items-center bg-gradient-to-r from-orange-500 via-red-500 to-pink-500 bg-clip-text text-transparent">
            <DocumentDuplicateIcon className="w-6 h-6 mr-2 text-orange-500" />
            Most Downloaded Notes
          </h3>
              ...
              mostDownloadedNotes.map((note, index) => (
                ...
                >
                  <div className="flex-1">
                    <p className="text-gray-900 dark:text-white font-medium">{note.title || 'Untitled'}</p>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Note ID: {note.note_id}</p>
                  </div>
                  <div className="text-right">
                    <p className="text-lg font-bold text-indigo-600 dark:text-indigo-400">{note.downloads}</p>
        ...
        <Card className="p-6">
          <h3 className="text-lg font-bold mb-4 flex items-center bg-gradient-to-r from-orange-500 via-red-500 to-pink-500 bg-clip-text text-transparent">
            <UsersIcon className="w-6 h-6 mr-2 text-red-500" />
            Top Contributors
          </h3>
          <div className="space-y-3">
              ...
              topContributors.map((contributor, index) => (
                ...
                >
                  <div className="flex items-center flex-1">
                    ...
                    <div>
                      <p className="text-gray-900 dark:text-white font-medium">{contributor.name || 'Unknown User'}</p>
                      <p className="text-sm text-gray-600 dark:text-gray-400">User ID: {contributor.user_id}</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="text-lg font-bold text-purple-600 dark:text-purple-400">{contributor.count}</p>
      ...
      {/* Quick Actions */}
      <div>
        <h2 className="text-xl font-bold mb-4 bg-gradient-to-r from-orange-500 via-red-500 to-pink-500 bg-clip-text text-transparent">Quick Actions</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="bg-gradient-to-br from-orange-500 to-red-500 text-white p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all flex flex-col items-center justify-center space-y-3"
          >
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="bg-gradient-to-br from-red-500 to-pink-500 text-white p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all flex flex-col items-center justify-center space-y-3"
          >
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="bg-gradient-to-br from-pink-500 to-rose-500 text-white p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all flex flex-col items-center justify-center space-y-3"
          >
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="bg-gradient-to-br from-rose-500 to-red-600 text-white p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all flex flex-col items-center justify-center space-y-3"
          >
